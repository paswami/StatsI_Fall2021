...
mod1 <- lm(data = salary, Salary_9_mo ~ Rank_Code + Gender + Avg_Cont_Grants)

# This is an interaction model between two dummy vars
mod2 <- lm(data = salary, Salary_9_mo ~ Rank_Code * Gender + Avg_Cont_Grants)
...
ggplot(salary, aes(Avg_Cont_Grants, Salary_9_mo)) +
  ...
  geom_line(data = augment(mod1), aes(y = .fitted, 
                                      linetype = Gender, 
...
ggplot(salary, aes(Avg_Cont_Grants, Salary_9_mo)) +
  geom_point(aes(colour = factor(Rank_Code))) +
  geom_line(data = augment(mod2), aes(y = .fitted, 
                                      linetype = Gender, 
                                      colour = factor(Rank_Code))) +
...
mod3 <- lm(data = salary, Salary_9_mo ~ Rank_Code + Gender + Avg_Cont_Grants + Rank_Code:Gender + Rank_Code:Avg_Cont_Grants)
